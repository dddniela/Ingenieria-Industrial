  ...
  <div id="myCarousel" class="carousel slide col-lg-12 col-sm-12" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img src="img/IMG-38.webp" class="d-block w-100 align-middle" width="100%" height="100%">
        <div class="container">
      ...
      <div class="d-flex justify-content-center align-items-center w-100 h-100">
        <div class="row g-0">
          ...
          <div class="col-12" style="text-align: center;">
            <p style="text-align: justify;"> La Ingeniería Industrial es una de las ramas de la Ingeniería que tiene por objetivo poder brindar crecimiento en las empresas, reduciendo costos. Que, a su vez busca generar más empleos, cuidar el medio ambiente y generar mejores condiciones de trabajo.  
  ...
  <div class="row g-0">
    ...
    <div class="col-lg-4 col-sm-6 text-center p-3">
      <div class="area shadow-sm p-4">
        ...
        <h3 class="areaTitle text-center font-bold text-xl">Calidad y productividad</h3>
        <p class="areaText">Pendiente.</p>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-6 text-center p-3">
      <div class="area shadow-sm p-4">
        ...
        <h3 class="areaTitle text-center font-bold text-xl">Formulación y Evaluación de Proyectos de Inversión</h3>
        <p class="areaText">Pendiente</p>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-6 text-center p-3">
      <div class="area shadow-sm p-4">
        ...
        <h3 class="areaTitle text-center font-bold text-xl">Planeación y Control de la Productividad</h3>
        <p class="areaText">Pendiente</p>
      </div>
    </div>
...
<section class="darkSection bg-dark p-2 px-4">
  <div class="row mb-4 px-2 g-0">
    ...
    <div class="col-lg-6 col-12 p-4 shadow-sm">
      <div class="d-flex justify-content-center align-items-center w-100 h-100">
        <img class="img-fluid rounded" src="img/IMG-27.webp" alt="">
      </div>
    </div>
...
<section class="p-2 g-0">
  ...
  <div class="row g-0">
    <h4 class="sectionTitle  text-center font-bold">Coordinación Industrial</h4>
    <div class="d-flex flex-row justify-content-center">
      <a class="mx-2" href="https://www.facebook.com/CoordinacionIndustrialITVer/" target="_blank"
        style="text-decoration: none;">
        <div class="d-flex flex-row justify-content-center">
