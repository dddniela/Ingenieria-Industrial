  ...
  <div id="myCarousel" class="carousel slide col-lg-12 col-sm-12" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="img/carrusel-ind-1.webp" class="d-block w-100 align-middle" width="100%" height="100%">
        <div class="container">
          <div class="carousel-caption d-flex flex-column">
            <h1 class="mainTitle text-center font-bold m-2 shadow-text">Ingeniería Industrial</h1>
            <h2 class="mainSubtitle text-center font-bold shadow-text">Modela tu éxito</h1>
      ...
      <div class="carousel-item">
        <img src="img/carrusel-ind-2.webp" class="d-block w-100 align-middle" width="100%" height="100%">
        <div class="container">
          <div class="carousel-caption">
            <h1 class="mainTitle text-center font-bold m-2 shadow-text">Ingeniería Industrial</h1>
            <h2 class="mainSubtitle text-center font-bold shadow-text">Crea soluciones ingeniosas</h1>
      ...
      <div class="carousel-item">
        <img src="img/carrusel-ind-3.webp" class="d-block w-100 align-middle" width="100%" height="100%">
        <div class="container">
          <div class="carousel-caption">
            <h1 class="mainTitle text-center font-bold m-2 shadow-text">Ingeniería Industrial</h1>
  ...
  <div class="row px-2 g-0">
    <div class="col-lg-6 col-12 p-2 shadow-sm">
      <div class="d-flex justify-content-center align-items-center w-100 h-100">
        <img class="img-fluid rounded" src="img/img-inicio.webp" alt="">
      </div>
    </div>
    ...
    <div class="lightSection col-lg-6 col-12 p-4">
      <div class="d-flex justify-content-center align-items-center w-100 h-100">
        <div class="row g-0">
          <div class="col-12">
            <h2 class="sectionTitle text-center font-bold m-3">¿Por qué estudiar Ingeniería Industrial?</h2>
  ...
  <div class="row g-0">
    ...
    <div class="col-lg-4 col-sm-6 text-center p-3">
      <div class="area shadow-sm p-4">
        <a href="?option=3.php">
          <img class="areaImage items-center" src="img/topicos/calidad.png" alt="">
        </a>
        <h3 class="areaTitle text-center font-bold text-xl">Calidad</h3>
        <p class="areaText">Aprende sobre estándares de excelencia que reflejan la capacidad de un producto, servicio o proceso para cumplir las expectativas.</p>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-6 text-center p-3">
      <div class="area shadow-sm p-4">
        <a href="?option=3">
          <img class="areaImage items-center" src="img/topicos/operaciones.png" alt="">
        </a>
        <h3 class="areaTitle text-center font-bold text-xl">Administración de Operaciones</h3>
        <p class="areaText">Desarolla la capacidad de planificar, organizar y supervisar eficazmente los procesos de producción y entrega en una organización.</p>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-6 text-center p-3">
      <div class="area shadow-sm p-4">
        <a href="?option=3">
          <img class="areaImage items-center" src="img/topicos/proyectos.png" alt="">
        </a>
        <h3 class="areaTitle text-center font-bold text-xl">Formulación y Evaluación de Proyectos</h3>
        <p class="areaText">Definir, planificar y analizar proyectos para determinar su viabilidad económica.</p>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-6 text-center p-3">
      <div class="area shadow-sm p-4">
        <a href="?option=3">
          <img class="areaImage items-center" src="img/topicos/productividad.png" alt="">
        </a>
        <h3 class="areaTitle text-center font-bold text-xl">Procesos, procedimientos y productividad</h3>
        <p class="areaText">Métodos sistemáticos para realizar tareas en una organización, mejorando la productividad.</p>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-6 text-center p-3">
      <div class="area shadow-sm p-4">
        <a href="?option=3">
          <img class="areaImage items-center" src="img/topicos/seguridad.png" alt="">
        </a>
        <h3 class="areaTitle text-center font-bold text-xl">Seguridad e Higiene Industrial</h3>
        <p class="areaText">Prevenir accidentes y enfermedades laborales, promoviendo un entorno de trabajo seguro y saludable para los empleados.</p>
      </div>
    </div>
...
<section class="darkSection bg-dark p-2 px-4">
  <div class="row mb-4 px-2 g-0">
        ...
        <div class="row g-0">
          ...
          <div class="col-12 px-4" style="text-align: center;">
            <p class="text-light" style="text-align: justify;">
              El departamento de Ingeniería Industrial cuenta con aulas diseñadas adecuadamente para el desempeño de la actividad educativa; Sala de Antropometría, Sala de Seguridad e Higiene, Sala Digital y Laboratorio de Estudio de Trabajo.
              <br></br>
              Las instalaciones están orientadas para el desarrollo de las competencias necesarias de los estudiantes asi como para llevar a cabo un aprendizaje didáctico, desarrollando proyectos y aplicando herramientas de Ingeniería Industrial.
            </p>
    ...
    <div class="col-lg-6 col-12 p-4 shadow-sm">
      <div class="d-flex justify-content-center align-items-center w-100 h-100">
        <img class="img-fluid rounded" src="img/img-instalaciones.webp" alt="">
      </div>
    </div>
...
<section class="p-2 g-0">
    ...
    <div class="col-12 col-md-6">
      ...
      <div class="d-flex flex-row justify-content-center">
        ...
        <a class="mx-2" href="https://X.com/TecNM_MX" target="_blank" style="text-decoration: none;">
          <div class="d-flex flex-row justify-content-center">
            <img class="img-fluid shadow-1-strong rounded mb-4 p-1" style="height: 40px" src="img/iconos/logo-X.png"
              alt="">
          </div>
        </a>
  ...
  <div class="row g-0">
    ...
    <div class="d-flex flex-row justify-content-center">
      <a class="mx-2" href="https://www.facebook.com/profile.php?id=100091786227340" target="_blank"
        style="text-decoration: none;">
        <div class="d-flex flex-row justify-content-center">
      ...
      <a class="mx-2" href="https://www.youtube.com/@DptoIngenieriaIndustrialITVer" target="_blank"
          style="text-decoration: none;">
          <div class="d-flex flex-row justify-content-center">
            <img class="img-fluid shadow-1-strong rounded mb-4 p-1" style="height: 40px" src="img/iconos/youtube.PNG"
              alt="">
