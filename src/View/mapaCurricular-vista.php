<div class="row g-0">
    <div class="position-relative w-100 overflow-hidden">
        <img class="w-100 img-fluid" src="img/banner-mapa2.webp" alt="">
        <div class="position-absolute top-50 start-50 translate-middle w-100">
            <div class="d-flex flex-column justify-content-center align-items-center text-center">
                <h1 class="fw-bold text-warning shadow-text">Mapa Curricular</h1>
                <h1 class="fw-bold text-light d-md-flex d-none shadow-text">Ingeniería Industrial</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="bg-primary pt-5">
        <section class="lightSection bg-light">
            <div class="row px-2 g-0">
                ...
                <div class="col-lg-6 col-12 p-2 shadow-sm">
                    <div class="d-flex justify-content-center align-items-center w-100 h-100">
                        <img class="img-fluid rounded" src="img/verano2.webp" alt="">
                    </div>
                </div>
